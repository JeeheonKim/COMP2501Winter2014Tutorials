...
bool SystemClass::Frame()
{
	...
	if ( m_Input->IsKeyDown(VK_RIGHT) )
		m_Collisions->MoveIfNotColliding(m_Robot, m_EnemyRobot, &Robot::MoveRight);
	if ( m_Input->IsKeyDown(VK_UP) )
		m_Collisions->MoveIfNotColliding(m_Robot, m_EnemyRobot, &Robot::MoveUp);
	if ( m_Input->IsKeyDown(VK_DOWN) )
		m_Collisions->MoveIfNotColliding(m_Robot, m_EnemyRobot, &Robot::MoveDown);
